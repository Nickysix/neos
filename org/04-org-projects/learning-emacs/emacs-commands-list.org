 ...
 C-k C-k C-d -- delete current macro from ring
 C-k C-k C-p -- switch to previous macro in ring
 C-k C-k C-n -- switch to next macro in ring
 ...
 * . -- mark extension
 ...
 M-x sql-informix -- open DB2 interactive buffer
 M-x sql-ingres -- open Informix interactive buffer
